...
if __name__ == "__main__":
    ...
    dataset = MyDataset(dataset_df, dataset_df['Question'], gpt2_type="gpt2")
...
#     torch.save(model, 'model.pt')
    ...
    prompt_generated_questions = generate(model.to('cpu'), tokenizer, "List of questions to ask someone:\n1.", entry_count = 1000, entry_length = 150)
